...
public class TaskAlertsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFabNewAlert.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), TaskAlertEditActivity.class));
            }
        });
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu)
    {
        ...
        inflater.inflate(R.menu.task_alert_menu, menu);
        return true;
    }
}
